...
<div style="text-align:center">
  <h1>Upitnik procjene rizika</h1>
  <h4>Ime korisnika: {{$client->name}} {{$client->surname}}</h4>
...
<div style="text-align:center">
  <br>
    <button class="button" style="border-radius: 20px"><a href="{{ route('clients.show', $client) }}">Nazad</a></button>
  <br>
  <br>
